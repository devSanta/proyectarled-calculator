...
<div id="modal-product" class="led-modal-content" style="display:none;">
	...
	<p class="led-modal-text">
		¿Qué características tienen y que cantidad?
	</p>
	...
	<div class="cat-selected">
		...
		<img id="cat-img" src="" alt="" class="led-select-img" style="display:none;">
	</div>
	...
	<div id="product-options">
		...
		<input id="product-quantity" type="number" name="quantity" min="1" value="1">
